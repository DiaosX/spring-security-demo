package com.mytest.springsecuritydemo2.common.util;

import com.mytest.springsecuritydemo2.common.sercurity.JwtTokenVerifyResult;
...
//    }
    ...
    public String createToken(UserDetailsDTO userDetails) {
        ...
        claims.put(CLAIM_KEY_PERMISSION, userDetails.getAuthorities());
